...
import 'package:jogo_cultura_paraense/games/artesanato-fauna-flora/components3/background.dart';
import 'package:jogo_cultura_paraense/games/artesanato-fauna-flora/components3/high_score.dart';
import 'package:jogo_cultura_paraense/games/artesanato-fauna-flora/components3/hint_button.dart';
import 'package:jogo_cultura_paraense/games/artesanato-fauna-flora/components3/start_button.dart';
import 'package:jogo_cultura_paraense/games/artesanato-fauna-flora/components3/timer.dart';
import 'package:jogo_cultura_paraense/games/artesanato-fauna-flora/views3/end_game.dart';
import 'package:jogo_cultura_paraense/games/artesanato-fauna-flora/views3/how_to.dart';
import 'package:jogo_cultura_paraense/pages/score_page.dart';
import 'components3/hud.dart';
import 'components3/tile.dart';
import 'components3/views.dart';
import 'dart:math';

class FindGame3 extends Game with TapDetector {
...
// inicializa as views do game
  ...
  FindGame3({this.context, this.topScore}) {
    initialize();
  }
