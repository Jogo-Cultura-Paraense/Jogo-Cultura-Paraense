...
class MainVocabularioScreen extends State<MainVocabulario> {
  ...
  double screenWidth;
  List<String> words = ["Baldear", "Visagem", "Carapanã", "Pegar o Beco", "Pitiú"]..shuffle();
  List<String> answers = ["Mosquito", "Ir Embora", "Vomitar", "Mau Cheiro", "Assombração"]..shuffle();
              ...
              children: <Widget> [
                          ...
                          children: [
                            ...
                            Padding(
                                ...
                                child: GestureDetector (
                                    ...
                                    child: Icon (
                                      usedHint ? Icons.block_outlined : Icons.lightbulb_outline ,
                                      size: 45.0,
                                      color: Colors.white,
                                    ))
                            )),
                            Text (
                                "PONTUAÇÃO: ${score.round()}",
                                style: TextStyle(fontSize: 20.0, color: Colors.black)
                            ),
                          ],
                        )
                ...
                Row(
                  children: <Widget> [
                    ...
                    Padding (
                      padding: EdgeInsets.only(left: this.screenWidth/1.35, bottom: 20),
                      child: Icon (
                          Icons.arrow_drop_down_circle_rounded ,
                          size: 45.0
                      ),
                    ...
                    child:
                          Row(
                            ...
                            Column(
                                ...
                                children :
                                  wordsListWidget(words),
                                ),
                            Column(
                                crossAxisAlignment: CrossAxisAlignment.end,
                                children :
                                  answersListWidget(answers),
                                ),
                          ])
                      ,
                    ),
