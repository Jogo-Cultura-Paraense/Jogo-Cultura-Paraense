...
import 'dart:async';
import 'package:jogo_cultura_paraense/games/lendas_mitos/gesture_box.dart';
...
class mainLendasMitosScreen extends State<mainLendasMitos>{
  ...
  Widget build(BuildContext context) {
    GestureBox game = GestureBox(MediaQuery.of(context).size.height, MediaQuery.of(context).size.width);
    runApp(game.widget);
    return Scaffold(
